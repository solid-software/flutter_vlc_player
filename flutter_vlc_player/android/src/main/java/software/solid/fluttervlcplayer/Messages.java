...
public class Messages {
  ...
  public static class SpuTracksMessage {
    ...
    static SpuTracksMessage fromMap(Map<Integer, String> map) {
  ...
  public static class AudioTracksMessage {
    ...
    static AudioTracksMessage fromMap(Map<Integer, String> map) {
  ...
  public static class RendererServicesMessage {
    ...
    static RendererServicesMessage fromMap(Map<String, String> map) {
