...
public class Messages {
  ...
  public static class CreateMessage {
    ...
    public void setPlayerId(Long setterArg) { this.playerId = setterArg; }
    ...
    static CreateMessage fromMap(Map<String, Object> map) {
      ...
      fromMapResult.playerId = (playerId == null) ? null : ((playerId instanceof Integer) ? (Integer)playerId : (Long)playerId);
  ...
  public static class PlayerMessage {
    ...
    static PlayerMessage fromMap(Map<String, Object> map) {
      PlayerMessage fromMapResult = new PlayerMessage();
      Object playerId = map.get("playerId");
      fromMapResult.playerId = (playerId == null) ? null : ((playerId instanceof Integer) ? (Integer)playerId : (Long)playerId);
      return fromMapResult;
    }
  ...
  public interface VlcPlayerApi {
    ...
    void dispose(PlayerMessage arg);
    void setStreamUrl(SetMediaMessage arg);
    void play(PlayerMessage arg);
    void pause(PlayerMessage arg);
    void stop(PlayerMessage arg);
    BooleanMessage isPlaying(PlayerMessage arg);
    BooleanMessage isSeekable(PlayerMessage arg);
    void setLooping(LoopingMessage arg);
    void seekTo(PositionMessage arg);
    PositionMessage position(PlayerMessage arg);
    DurationMessage duration(PlayerMessage arg);
    void setVolume(VolumeMessage arg);
    VolumeMessage getVolume(PlayerMessage arg);
    void setPlaybackSpeed(PlaybackSpeedMessage arg);
    PlaybackSpeedMessage getPlaybackSpeed(PlayerMessage arg);
    SnapshotMessage takeSnapshot(PlayerMessage arg);
    TrackCountMessage getSpuTracksCount(PlayerMessage arg);
    SpuTracksMessage getSpuTracks(PlayerMessage arg);
    void setSpuTrack(SpuTrackMessage arg);
    SpuTrackMessage getSpuTrack(PlayerMessage arg);
    void setSpuDelay(DelayMessage arg);
    DelayMessage getSpuDelay(PlayerMessage arg);
    void addSubtitleTrack(AddSubtitleMessage arg);
    TrackCountMessage getAudioTracksCount(PlayerMessage arg);
    AudioTracksMessage getAudioTracks(PlayerMessage arg);
    void setAudioTrack(AudioTrackMessage arg);
    AudioTrackMessage getAudioTrack(PlayerMessage arg);
    void setAudioDelay(DelayMessage arg);
    DelayMessage getAudioDelay(PlayerMessage arg);
    void addAudioTrack(AddAudioMessage arg);
    TrackCountMessage getVideoTracksCount(PlayerMessage arg);
    VideoTracksMessage getVideoTracks(PlayerMessage arg);
    void setVideoTrack(VideoTrackMessage arg);
    VideoTrackMessage getVideoTrack(PlayerMessage arg);
    void setVideoScale(VideoScaleMessage arg);
    VideoScaleMessage getVideoScale(PlayerMessage arg);
    void setVideoAspectRatio(VideoAspectRatioMessage arg);
    VideoAspectRatioMessage getVideoAspectRatio(PlayerMessage arg);
    RendererServicesMessage getAvailableRendererServices(PlayerMessage arg);
    void startRendererScanning(RendererScanningMessage arg);
    void stopRendererScanning(PlayerMessage arg);
    RendererDevicesMessage getRendererDevices(PlayerMessage arg);
    void castToRenderer(RenderDeviceMessage arg);
    BooleanMessage startRecording(RecordMessage arg);
    BooleanMessage stopRecording(PlayerMessage arg);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              PlayerMessage input = PlayerMessage.fromMap((Map<String, Object>)message);
              api.dispose(input);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
