...
public class Messages {
  ...
  public static class IntMessage {
    ...
    static IntMessage fromMap(Map<String, Object> map) {
      IntMessage fromMapResult = new IntMessage();
      Object viewId = map.get("viewId");
      fromMapResult.viewId = (viewId == null) ? null : ((viewId instanceof Integer) ? (Integer)viewId : (Long)viewId);
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class CreateTextureMessage {
    ...
    static CreateTextureMessage fromMap(Map<String, Object> map) {
      CreateTextureMessage fromMapResult = new CreateTextureMessage();
  ...
  public interface VlcPlayerApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, VlcPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VlcPlayerApi.createTextureEntry", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VlcPlayerApi.disposeTextureEntry", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              IntMessage input = IntMessage.fromMap((Map<String, Object>)message);
              api.disposeTextureEntry(input);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
