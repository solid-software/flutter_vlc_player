...
class VlcPlayerController extends ValueNotifier<VlcPlayerValue> {
  ...
  /// The playerId for this controller
  late int _playerId;
  ...
  Future<void> dispose() async {
    ...
    super.dispose();
    //
    await vlcPlayerPlatform.dispose(_playerId);
  }
  ...
  Future<void> _setStreamUrl(
    ...
    await vlcPlayerPlatform.stop(_playerId);
  ...
  Future<void> play() async {
    ...
    await vlcPlayerPlatform.play(_playerId);
  ...
  Future<void> pause() async {
    ...
    await vlcPlayerPlatform.pause(_playerId);
  }
  ...
  Future<void> seekTo(Duration position) async {
    ...
    await vlcPlayerPlatform.seekTo(_playerId, position);
  }
  ...
  Future<Duration> getPosition() async {
    ...
    var position = await vlcPlayerPlatform.getPosition(_playerId);
  ...
  Future<void> setVolume(int volume) async {
    ...
    await vlcPlayerPlatform.setVolume(_playerId, value.volume);
  }
  ...
  Future<int> getVolume() async {
    ...
    var volume =
        await (vlcPlayerPlatform.getVolume(_playerId) as FutureOr<int>);
    value = value.copyWith(volume: volume.clamp(0, 100));
    return volume;
  }
  ...
  Future<Duration> getDuration() async {
    ...
    var duration = await vlcPlayerPlatform.getDuration(_playerId);
  ...
  Future<double?> getPlaybackSpeed() async {
    ...
    var speed = await vlcPlayerPlatform.getPlaybackSpeed(_playerId);
    value = value.copyWith(playbackSpeed: speed);
    return speed;
  }
  ...
  Future<int?> getSpuTracksCount() async {
    ...
    var spuTracksCount = await vlcPlayerPlatform.getSpuTracksCount(_playerId);
  ...
  Future<Map<int, String>> getSpuTracks() async {
    ...
    return await vlcPlayerPlatform.getSpuTracks(_playerId);
  }
  ...
  Future<void> setSpuTrack(int spuTrackNumber) async {
    ...
    return await vlcPlayerPlatform.setSpuTrack(_playerId, spuTrackNumber);
  }

  /// Returns active spu track index
  Future<int?> getSpuTrack() async {
    _throwIfNotInitialized('getSpuTrack');
    var activeSpuTrack = await vlcPlayerPlatform.getSpuTrack(_playerId);
  ...
  Future<void> setSpuDelay(int spuDelay) async {
    ...
    return await vlcPlayerPlatform.setSpuDelay(_playerId, spuDelay);
  }

  /// Returns the amount of subtitle time delay.
  Future<int?> getSpuDelay() async {
    _throwIfNotInitialized('getSpuDelay');
    var spuDelay = await vlcPlayerPlatform.getSpuDelay(_playerId);
    value = value.copyWith(spuDelay: spuDelay);
    return spuDelay;
  }
  ...
  Future<int?> getAudioTracksCount() async {
    ...
    var audioTracksCount =
        await vlcPlayerPlatform.getAudioTracksCount(_playerId);
  ...
  Future<Map<int, String>> getAudioTracks() async {
    ...
    return await vlcPlayerPlatform.getAudioTracks(_playerId);
  }

  /// Returns active audio track index
  Future<int?> getAudioTrack() async {
    _throwIfNotInitialized('getAudioTrack');
    var activeAudioTrack = await vlcPlayerPlatform.getAudioTrack(_playerId);
  ...
  Future<void> setAudioTrack(int audioTrackNumber) async {
    ...
    return await vlcPlayerPlatform.setAudioTrack(_playerId, audioTrackNumber);
  }
  ...
  Future<void> setAudioDelay(int audioDelay) async {
    ...
    return await vlcPlayerPlatform.setAudioDelay(_playerId, audioDelay);
  }
  ...
  Future<int?> getAudioDelay() async {
    ...
    var audioDelay = await vlcPlayerPlatform.getAudioDelay(_playerId);
    value = value.copyWith(audioDelay: audioDelay);
    return audioDelay;
  }
  ...
  Future<int?> getVideoTracksCount() async {
    ...
    var videoTracksCount =
        await vlcPlayerPlatform.getVideoTracksCount(_playerId);
  ...
  Future<Map<int, String>> getVideoTracks() async {
    ...
    return await vlcPlayerPlatform.getVideoTracks(_playerId);
  }
  ...
  Future<void> setVideoTrack(int videoTrackNumber) async {
    ...
    return await vlcPlayerPlatform.setVideoTrack(_playerId, videoTrackNumber);
  }

  /// Returns active video track index
  Future<int?> getVideoTrack() async {
    _throwIfNotInitialized('getVideoTrack');
    var activeVideoTrack = await vlcPlayerPlatform.getVideoTrack(_playerId);
  ...
  Future<void> setVideoScale(double videoScale) async {
    ...
    return await vlcPlayerPlatform.setVideoScale(_playerId, videoScale);
  }

  /// Returns video scale
  Future<double?> getVideoScale() async {
    _throwIfNotInitialized('getVideoScale');
    var videoScale = await vlcPlayerPlatform.getVideoScale(_playerId);
    value = value.copyWith(videoScale: videoScale);
    return videoScale;
  }
  ...
  Future<void> setVideoAspectRatio(String aspectRatio) async {
    ...
    return vlcPlayerPlatform.setVideoAspectRatio(_playerId, aspectRatio);
  }
  ...
  Future<String?> getVideoAspectRatio() async {
    ...
    return vlcPlayerPlatform.getVideoAspectRatio(_playerId);
  }
  ...
  Future<Uint8List> takeSnapshot() async {
    ...
    return await vlcPlayerPlatform.takeSnapshot(_playerId);
  }
  ...
  Future<List<String>> getAvailableRendererServices() async {
    ...
    return await vlcPlayerPlatform.getAvailableRendererServices(_playerId);
  }
  ...
  Future<void> startRendererScanning({String? rendererService}) async {
    ...
    return await vlcPlayerPlatform.startRendererScanning(_playerId,
  ...
  Future<void> stopRendererScanning() async {
    ...
    return await vlcPlayerPlatform.stopRendererScanning(_playerId);
  }
  ...
  Future<Map<String, String>> getRendererDevices() async {
    ...
    return await vlcPlayerPlatform.getRendererDevices(_playerId);
  }
  ...
  Future<void> castToRenderer(String castDevice) async {
    ...
    return await vlcPlayerPlatform.castToRenderer(_playerId, castDevice);
  }
  ...
  Future<bool?> startRecording(String saveDirectory) async {
    ...
    return await vlcPlayerPlatform.startRecording(_playerId, saveDirectory);
  }

  /// Returns true if media is stop recording.
  Future<bool?> stopRecording() async {
    _throwIfNotInitialized('stopRecording');
    return await vlcPlayerPlatform.stopRecording(_playerId);
  }
  ...
  Future<void> onPlatformViewCreated(int playerId) async {
    _playerId = playerId;
